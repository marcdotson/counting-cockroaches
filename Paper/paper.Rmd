...
## Intro to XGBoost
XGBoost is a tool that uses gradient-boosted trees for classification. A basic understanding of decision trees and random forests is crucial to understanding gradient-boosting as well as the XGBoost package.

Decision Trees:
Decision trees are models that use a series of binary (yes/no) questions, and classify something based on the answers to those binary questions. 
