...
simulate_mrp_data <- function(n) {
  ...
  ## For respondent i, people[i] is that person's post-strat cell,
...
Post-Stratification consists of taking the sum of the estimates of the model for each cell times the number of people in each cell divided by the total number of people
