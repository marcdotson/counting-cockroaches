---
title: "fastText Clust EDA"
output: github_document
---

# Overview 
These are my annotations on the "fasttext_clust_EDA.R" script written by Adriel
...
sample_tweets %>%
  .$tweet_text %>% 
  write_lines("../../Temporary/tweet_sample_1mil.txt")
...
sample_tweets %>%
  .$tweet_text %>%
  write_lines("../../Temporary/tweet_sample_2M_noRT.txt")
rm(sample_tweets)
...
file_model200 <- "../../Temporary/model200.dat"
file_model150 <- "../../Temporary/model150.dat"
file_model100 <- "../../Temporary/model100.dat"
file_model50  <- "../../Temporary/model50.dat"
file_model25  <- "../../Temporary/mode25.dat"

 # execute(commands = c("cbow", "-input", file_txt, "-output", file_model200, "-verbose", 1, "-dim", 200))
model200 <- load_model(file_model200)

 # execute(commands = c("cbow", "-input", file_txt, "-output", file_model150, "-verbose", 4, "-dim", 150))
model150 <- load_model(file_model150)

 # execute(commands = c("cbow", "-input", file_txt, "-output", file_model100, "-verbose", 4, "-dim", 100))
model100 <- load_model(file_model100)

 # execute(commands = c("cbow", "-input", file_txt, "-output", file_model50, "-verbose", 4, "-dim", 50))
model50 <- load_model(file_model50)

 # execute(commands = c("cbow", "-input", file_txt, "-output", file_model25, "-verbose", 4, "-dim", 25))
...
sample_tweets <- 
  read_lines("../../Temporary/tweet_sample_1hM_noRT.txt") %>% 
  tibble(tweet_text = .) 
