...
library(Matrix)
library(xgboost)
source(here::here("Code", "dallin_annotations", "06_define_prediction_functions.R")) # Formerly "R/predict_func.R" in Adriel's original code
source(here::here("Code", "dallin_annotations", "08_define_tweet_complaint_predictor_function.R")) # Formerly "R/TweetComplaintPredictor.r" in Adriel's original code
```
...
# Load Models
```{r}
load(here::here("Output", "prcomp4.dat")) # Formerly "complaint-prediction/models/fullClassifierOne/prcomp4.dat" in Adriel's original code
