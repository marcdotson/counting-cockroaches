...
From this graph, apparently I messed up somewhere in making predictions, because the predictions being made seem to have no correlation with the actual complaint label. It could be that, or the fastText model needs significantly more text to train and be accurate. 
```{r}
tested %>% 
...
I'll try to use our fasttext model using bash.
Navigate to the right directory of the model:
```{bash error = TRUE}
