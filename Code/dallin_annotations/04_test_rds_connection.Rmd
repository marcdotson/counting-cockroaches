...
Now that we have wrangled the data and saved it as an object in our environment, we want to use the write_lines() function to save this data file as a .txt file.
```{r}
# Pull Data Sample --------------------------------------------------------
