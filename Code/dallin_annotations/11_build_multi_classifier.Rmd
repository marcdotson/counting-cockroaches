...
# Overview
In this document, I will try to make a classification model similar to the one in 07_build_classifier.Rmd. The difference here will be that I will attempt to build a classification model meant to predict based on a set of many complaint categories.
...
This dataset was created in file 07_build_classifier.Rmd
```{r}
